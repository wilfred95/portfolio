...
export default function Hero() {
  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden geometric-bg">
      ...
      >
        ...
        <motion.h1
          ...
          className="text-4xl md:text-6xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white via-blue-500 to-red-600"
        >
          Backend Developer
        </motion.h1>
        ...
        >
          ...
          <Button
            size="lg"
            variant="outline"
            className="border-zinc-600 hover:border-blue-500 text-white"
            asChild
            onClick={(e) => {
              e.preventDefault();
