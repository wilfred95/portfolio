  ...
  const experiences: Experience[] = [
    {
      ...
      technologies: ["Node.js", "Express", "PostgreSQL", "Docker", "Digital Ocean", "Stripe", "Nodemailer", "AWS S3 Bucket"],
    ...
    },
    {
      ...
      technologies: ["Node.js", "Express", "MySQL", "Docker", "AWS ECS", "AWS S3 Bucket", "Paystack", "Nodemailer", "AWS Amplify", "Flowise AI"],
    ...
    },
    {
      ...
      technologies: ["Node.js", "Express.js", "PostgreSQL", "Docker", "Digital Ocean", "Paystack", "Nodemailer", "AWS S3 Bucket", "Redis", "Vite", "WebSockets"],
    ...
    },
    {
      ...
      },
      {
        ...
        technologies: ["Node.js", "Express.js", "PostgreSQL","TypeScript", "Docker", "Supabase", "Render", "Golang","Solidity", "Smart Contract"],
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {exp.technologies.map((tech, i) => (
                          <Badge key={i} variant="outline" className="bg-zinc-700 text-zinc-300 border-zinc-600">
                            {tech}
                          </Badge>
                        ))}
                      </div>
